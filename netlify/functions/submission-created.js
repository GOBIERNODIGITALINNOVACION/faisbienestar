...
// TikTok Events API Configuration for FAIS Bienestar
const TIKTOK_PIXEL_ID = 'D5MJ79RC77UALNU7I4JG';
...
exports.handler = async (event) => {
  ...
  try {
    ...
    // Build TikTok Events API payload (without value/currency as requested)
    const tiktokPayload = {
      ...
      data: [
        {
          ...
          user: user,
          page: {
            url: payload.site_url || 'https://faisbienestar.com',
            referrer: ''
          },
          properties: {
            content_name: formName || 'solicitud-fais',
